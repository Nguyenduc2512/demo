(function () {
	"use strict";
	devManagerApp.controller('chartsBieuDoThongKeNhanVienKinhDoanhCtrl', chartsBieuDoThongKeNhanVienKinhDoanhCtrl);

	chartsBieuDoThongKeNhanVienKinhDoanhCtrl.$inject = [];

	function chartsBieuDoThongKeNhanVienKinhDoanhCtrl() {
		var vm = this;
